...
class LabelOrderCard extends StatefulWidget {

  final Map<String, dynamic>? order;
  final Map<String, dynamic>? customerAccounts;

  const LabelOrderCard({super.key, this.order = const <String, dynamic> {}, this.customerAccounts = const <String, dynamic> {}});

  @override
  State<LabelOrderCard> createState() => _LabelOrderCardState();
}

class _LabelOrderCardState extends State<LabelOrderCard> {
          ...
          children: [
            Flexible(
              ...
              child: Row(
                ...
                children: [
                  Text("#${order?['ID']}"),
                  Text(widget.customerAccounts?[order?['account']] ??  order?['account'].toString()),
                ]
              )
            ),
